package com.example.digilib.ui.theme.screens.admin.bookListAdmin
...
@Composable
fun BookListAdminScreen(navController: NavController, viewModel: BookViewModel, authViewModel: AuthViewModel) {
                                    ...
                                    if (userId != null && userRole != null) {
                                        viewModel.requestToBorrow(
                                            ...
                                            navigateToAdminScreen = {
                                                navController.navigate("adminBorrowedBooks")
                                            },
                                            navigateToUserScreen = {
                                                navController.navigate("userBorrowedBooks")
                                            }
                                        )
                                    } else {
                                        Toast.makeText(
...
@Composable
fun BookListScreenAdminPreview() {
    BookListAdminScreen(navController = rememberNavController(), viewModel = BookViewModel(), authViewModel = AuthViewModel())
}
